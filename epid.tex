...
\includegraphics[width=1.0\textwidth]{sir_mcmc_test-1-1-1-1-125-traceplots-params}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{sir_pmcmc_test-1-2-3-3-30000-100-125-traceplots}
\end{minipage}
