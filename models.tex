...
\end{equation}
where $\epsilon_t \stackrel{iid}{\sim} \mbox{N}(0,\sigma^2_s)$. Note that only the first element of the state vector plays a role in equation \eqref{eqn:arma}.
...
\begin{equation}
x_0|\theta \sim \mbox{N}(0, \sigma^2_s\Omega), \label{eqn:arma:prior}
\end{equation}
