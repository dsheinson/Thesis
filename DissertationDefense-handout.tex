...
\[\mbox{conv}_t = \int_0^t N(\omega)h(t-\omega)d\omega\] \pause
...
\centering
\includegraphics[width=0.6\textwidth]{fmri-design-3-500-1}
}
...
\item fit residuals to zero-mean AR(1) process \pause
...
\item adjust degrees of freedom in t-test \pause
